...
function baseValidPayload() {
  return {
    ...
    fiscalYear: 2024,
    positions: [
      { statement: "aktiva" as const, code: "A", parentCode: null, label: "AV", level: 0, sortOrder: 0, betragCents: 1000, vorjahrCents: null, source: "pdf" as const },
      { statement: "passiva" as const, code: "B", parentCode: null, label: "EK", level: 0, sortOrder: 1, betragCents: 1000, vorjahrCents: null, source: "pdf" as const },
      { statement: "guv" as const, code: "guv.1", parentCode: null, label: "Umsatz", level: 0, sortOrder: 2, betragCents: 5000, vorjahrCents: null, source: "pdf" as const },
      { statement: "guv" as const, code: "guv.2", parentCode: null, label: "Aufwand", level: 0, sortOrder: 3, betragCents: -2000, vorjahrCents: null, source: "pdf" as const },
      { statement: "guv" as const, code: "guv.3", parentCode: null, label: "Ergebnis", level: 0, sortOrder: 4, betragCents: 3000, vorjahrCents: null, source: "pdf" as const },
    ],
    konten: [
      { statement: "aktiva" as const, positionCode: "A", kontoNr: "0300", label: "Grund", betragCents: 1000, vorjahrCents: null, sortOrder: 0 },
      { statement: "passiva" as const, positionCode: "B", kontoNr: "0800", label: "EK", betragCents: 1000, vorjahrCents: null, sortOrder: 1 },
    ],
  };
}
